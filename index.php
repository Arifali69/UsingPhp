...
if(isset($_POST['Submit']))
{
    ...
    $ename =$_POST['ename'];
    $cname =$_POST['cname'];
    echo $fname . "&nbsp &nbsp &nbsp" . $lname . "&nbsp &nbsp &nbsp" . $sname . "&nbsp &nbsp &nbsp" . $uname . "&nbsp &nbsp &nbsp" . $ename . "&nbsp &nbsp &nbsp" . $cname;
    echo "&nbsp &nbsp &nbsp";
...
<select  class="form-control selectpicker" name="sname">
...
<div class="input-group">
<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
<input placeholder="Username" class="form-control" name="uname" type="text">
</div>
</div>
</div>
<!-- Text input-->
...
<input  placeholder="E-Mail Address" class="form-control" name="ename" type="text">
</div>
</div>
</div>
<!-- Text input-->
...
<input placeholder="(639)" class="form-control" name="cname" type="text">
</div>
</div>
</div>
<!-- Select Basic -->
